...
[![GoDoc](https://godoc.org/github.com/mcfearsome/goproxy?status.svg)](https://godoc.org/github.com/mcfearsome/goproxy)
[![Join the chat at https://gitter.im/mcfearsome/goproxy](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/mcfearsome/goproxy?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)
![Status](https://github.com/mcfearsome/goproxy/workflows/Go/badge.svg)
...
Get the latest goproxy from `gopkg.in/mcfearsome/goproxy.v1`.
...
[the eavesdropper example](https://github.com/mcfearsome/goproxy/blob/master/examples/goproxy-eavesdropper/main.go#L27)
2. Transparent proxy support for http/https including MITM certificate generation for TLS.  See the [transparent example.](https://github.com/mcfearsome/goproxy/tree/master/examples/goproxy-transparent)
